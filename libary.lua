...
do
		...
		local container = utility:Create("ScreenGui", {
			...
			utility:Create("ImageLabel", {
				...
				utility:Create("ImageLabel", {
					...
					utility:Create("ImageLabel", { -- logo
						Name = "Logo",
	...
	function page.new(library, title, locked)
		local button = utility:Create("TextButton", {
			...
			locked and utility:Create("ImageLabel", {
				Name = "Locked", 
				AnchorPoint = Vector2.new(0, 0.5),
				BackgroundTransparency = 1,
	...
	function library:addPage(...)
		...
		button.MouseButton1Click:Connect(function()
			if button:FindFirstChild("Locked") then
				self:Notify("Page Restricted", "This page is restricted to premium users only, Upgrade in our Discord!")
			end
    ...
    function section:getModel(part)
		return self:getModule(part)
	end
